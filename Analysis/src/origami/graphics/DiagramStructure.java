...
import origami.graphics.widgets.DiagramDescriptionText;
...
public class DiagramStructure {
    ...
    private DiagramDescriptionText textDescription;
	...
	//Before sashForm
	//diagramArea = new Composite(sashForm,SWT.NONE);
		
	diagramArea = new SashForm(MainWindow.shell,SWT.NONE);
	...
	//For testing the sashForm
	textDescription = new DiagramDescriptionText(diagramArea);
	((SashForm)diagramArea).setWeights(new int[] {2, 1});	
	
    }
    
    private GridLayout getLayoutComposite(){
	GridLayout layoutComposite = new GridLayout(1, false);
	layoutComposite.horizontalSpacing =layoutComposite.verticalSpacing=5;
    ...
    //This method repaint every time when CTabItem is changed 
    ...
    public DiagramDescriptionText getTextDescription() {
        return textDescription;
    }

    public void setTextDescription(DiagramDescriptionText textDescription) {
