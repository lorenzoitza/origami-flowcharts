 ...
 */
public class CustomTabItem extends CTabItem {
    ...
    public CustomTabItem(CTabFolder arg0, int arg1, AdminSelection selec) {
	super(arg0, arg1);
	this.adminSelection = selec;
    }

    public void setTabFolder(CustomTabFolder tabfolder) {
	tab = tabfolder;
