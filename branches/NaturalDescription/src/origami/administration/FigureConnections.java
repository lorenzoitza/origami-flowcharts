...
public class FigureConnections extends Figure{
    ...
    private final Color COLOR = Display.getCurrent().getSystemColor(SWT.COLOR_BLACK);
    
    private CustomTabFolder tabFolder;

    private String yesMessage = "Si";

    private String noMessage = "No";
	
    public FigureConnections(CustomTabFolder tabfolder){
	tabFolder = tabfolder;
    }
	...
	for(index=0;index<tabFolder.getTabItem().getLeaf().getSizeDiagrama()-1;index++){
		...
		coneccion.setForegroundColor(COLOR);
		...
		thirdConnection.setForegroundColor(COLOR);
		...
		localizacion.setVDistance(-5);
		localizacion.setUDistance(15);
		...
		fourthConnection.setForegroundColor(COLOR);
		...
		decorationPointList2.addPoint(3,1);
		decorationPointList2.addPoint(3,-1);
		...
		decorationPointList3.addPoint(3,1);
		decorationPointList3.addPoint(3,-1);
		...
		fifthConnection.setForegroundColor(COLOR);
		...
		sixthConnection.setForegroundColor(COLOR);
	...
	while(true){
	    ...
	    conector.setForegroundColor(COLOR);
