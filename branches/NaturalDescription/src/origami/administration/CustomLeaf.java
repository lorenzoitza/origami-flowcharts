...
public class CustomLeaf {
    ...
    public CustomLeaf(CustomTabFolder tabfolder,AdminSelection seleccion){
	...
	public void addFigure(){
		...
		//Updating the content of the TextDescription when  if we can send text when the diagram change
		
		DiagramStructure.getInstance().getTextDescription().update(diagrama);
	}
	/**
	 * Mover metodo
	 */
