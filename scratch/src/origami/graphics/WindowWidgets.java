...
public class WindowWidgets {
     ...
     * */
    public GridData consoleData = new GridData(SWT.FILL, SWT.FILL, false,false, 3, 1);
    
    //public GridData diagramData = new GridData(SWT.FILL, SWT.FILL, true,true, 1, 1);
      public GridData diagramData = new GridData(SWT.FILL, SWT.FILL, false,true, 1, 1);
    
    
    private GridData tabData = new GridData(SWT.FILL, SWT.FILL, true,false, 3, 1);
    private GridData toolBarData = new GridData(SWT.FILL, SWT.FILL, true,false, 3, 1);
  ...
  //This method call TabFolder where is included ToolBar and Diagram
	...
	/*sashForm = new SashForm(MainWindow.shell,SWT.HORIZONTAL);
	sashForm.setSashWidth(5);
	
		
	tabFolder = new CustomTabFolder(sashForm, selec);
	tabFolder.addTabItem();
	
	tabData.heightHint = 0;
	
	Button one = new Button(sashForm, SWT.PUSH);
	    one.setText("One");
