...
public class DiagramStructure {
	...
	//new Button(MainWindow.shell, SWT.PUSH).setText("Right");
	initPanels();
	...
	org.eclipse.draw2d.GridData gridData = new org.eclipse.draw2d.GridData(SWT.FILL,SWT.FILL,false,true,1,1);
	...
	layoutComposite.marginWidth = layoutComposite.marginHeight = 5;
	return layoutComposite;
    }
    
    private GridData getLayoutFigureCanvas(){
	//GridData diagramaGrid =new GridData(SWT.FILL,SWT.FILL,true,true,1,1);
	GridData diagramaGrid =new GridData(SWT.FILL,SWT.FILL,false,true,1,1);
	return diagramaGrid;
    }
